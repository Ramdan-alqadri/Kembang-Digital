  ...
  return (
    <section id="contact" className="min-h-screen pt-20 pb-8 bg-kembang-pink relative overflow-hidden flex flex-col justify-center  ">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10 w-full">
        ...
        >
          <a href="#contact" onClick={(e) => { e.preventDefault(); navigate('contact'); }} className="bg-kembang-dark text-white hover:bg-white hover:text-kembang-dark px-8 py-4 rounded-full font-medium transition-colors shadow-lg hover:-translate-y-1">
            Mulai Ngobrol &rarr;
          </a>
          <a href="#works-page" onClick={(e) => { e.preventDefault(); navigate('works'); }} className="bg-transparent border border-white/30 text-white hover:bg-white/10 px-8 py-4 rounded-full font-medium transition-colors">
            Lihat Portfolio
          </a>
        </motion.div>
      </div>
